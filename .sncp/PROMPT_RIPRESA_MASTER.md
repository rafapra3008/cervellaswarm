...
|----------|----------------|------------|-------|
| **CervellaSwarm** | `.sncp/progetti/cervellaswarm/PROMPT_RIPRESA_cervellaswarm.md` | 2026-03-13 | S447: LU 1.1 Nested Choice DONE, 3466 test, 8 files, Guardiana 9.5+ |
...
- **13 Mar 2026:** PyPI v0.3.1 LIVE, LU 1.1 Nested Choice (S447), 3466 test, Dependabot cleanup
