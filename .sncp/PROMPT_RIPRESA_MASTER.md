...
> **Ultimo aggiornamento:** 18 Febbraio 2026 - Sessione 368
...
|----------|----------------|------------|-------|
| **CervellaSwarm** | `.sncp/progetti/cervellaswarm/PROMPT_RIPRESA_cervellaswarm.md` | 2026-02-18 | FASE 1 OPEN SOURCE! F1.1+F1.2+F1.3 done (9.5-9.6/10). Package `cervellaswarm-code-intelligence` v0.1.0 pronto. Next: F1.4 PyPI publish |
...
| **Contabilita** | `.sncp/progetti/contabilita/PROMPT_RIPRESA_contabilita.md` | 2026-02-18 | Sessione 73: Pulizia DuckDNS (9.2/10) + Subdomain lab.contabilitafamigliapra.it LIVE (8.5/10). Bug basic auth da investigare. Prossimo: FASE C Step 9-10 |
...
2. Leggi SOLO il file PROMPT_RIPRESA di quel progetto
3. NON leggere tutto - leggi quello che ti serve

FINE SESSIONE:
1. Aggiorna il file del progetto
2. Aggiorna la tabella qui sopra (data + TL;DR)
```
...
*"Ogni progetto ha la sua storia. Leggila separata."*
