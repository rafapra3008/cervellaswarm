...
class TestCachingPerformance:
    ...
    def test_cache_speedup(self):
        ...
        # Use a real file
        test_file = Path(__file__).parent.parent / "src" / "cervellaswarm_code_intelligence" / "symbol_extractor.py"
    ...
    def test_cache_stats(self):
        ...
        # Extract from a file
        test_file = Path(__file__).parent.parent / "src" / "cervellaswarm_code_intelligence" / "dependency_graph.py"
        if test_file.exists():
