...
class TestRealFiles:
    ...
    def test_extract_from_symbol_extractor(self, extractor):
        ...
        file_path = project_root / "src" / "cervellaswarm_code_intelligence" / "symbol_extractor.py"
    ...
    def test_extract_from_treesitter_parser(self, extractor):
        ...
        project_root = Path(__file__).parent.parent
        file_path = project_root / "src" / "cervellaswarm_code_intelligence" / "treesitter_parser.py"
