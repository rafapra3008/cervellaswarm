"""Fast unit tests for scripts.utils.semantic_search (with mocks).
...
from scripts.utils.semantic_search import SemanticSearch, find_symbol_in_repo
...
def mock_dependencies():
    ...
    with patch('scripts.utils.semantic_search.TreesitterParser') as mock_parser_cls, \
         patch('scripts.utils.semantic_search.SymbolExtractor') as mock_extractor_cls, \
         patch('scripts.utils.semantic_search.DependencyGraph') as mock_graph_cls:
