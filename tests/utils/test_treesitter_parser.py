"""Tests for scripts/utils/treesitter_parser.py.
...
@patch("scripts.utils.treesitter_parser.get_language")
...
@patch("scripts.utils.treesitter_parser.Parser")
@patch("scripts.utils.treesitter_parser.get_language")
...
@patch("scripts.utils.treesitter_parser.TreesitterParser")
