"""Tests for scripts/utils/repo_mapper_cli.py - Errors & Edge Cases
...
from scripts.utils.repo_mapper_cli import main
...
def mock_repo_mapper():
    ...
    with patch('scripts.utils.repo_mapper_cli.RepoMapper') as MockClass:
        mock_instance = Mock()
