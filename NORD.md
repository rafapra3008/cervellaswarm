...
>
> Aggiornato: 12 Marzo 2026 - S446 (v0.3.1 prep, stdlib wheel fix, 3436 test, README aggiornato)
...
|     T2.1 PyPI v0.3.1: PREP (stdlib in wheel, CHANGELOG, README)|
|   PyPI: v0.3.0 LIVE! v0.3.1 in prep (S446)                    |
|   29 moduli, 3436 test, 10 CLI cmd, 9 PropertyKind, ZERO deps  |
|                                                                  |
|   VISIONE (S442 - Rafa):                                        |
